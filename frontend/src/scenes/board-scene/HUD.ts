...
export class HUD extends Phaser.GameObjects.Container {
    ...
    constructor(scene: Phaser.Scene) {
        ...
        this.balanceLabel = new Phaser.GameObjects.Text(this.scene, yourBalanceLabel.x + yourBalanceLabel.width + 20, 5, GameVars.balance + " ETH" , {fontFamily: "RussoOne", fontSize: "40px", color: "#000000"});
